...
class HEDUNet(nn.Module):
    ...
    def __init__(self, input_channels, output_channels=1, merging="attention", base_channels=16,
                 conv_block=Convx2, padding_mode='replicate', batch_norm=False, stack_height=6,
                 squeeze_excitation=False, deep_supervision=True):
        super().__init__()
        bc = base_channels
